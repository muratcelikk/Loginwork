...
public class UpdatePageController {
	...
	public String updatePage(@PathVariable int crid, Model model, HttpServletRequest req) {
		...
		model.addAttribute("catData", new RegisterController().catResult());
